        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $result['SoLuong'] ?></td>
                        ...
                        if ($dayvalid > 0) {
                        ?>
                                     <td style="background-color: green;  color: #f1f1f1"><?php  echo "Còn " . strval($dayvalid) . " ngày"; ?></td>
                            <?php } else { ?>
                                    <td style="background-color: red; color: #f1f1f1"><?php  echo "Đã hết hạn" . str_replace("-", " ", strval($dayvalid)) . " ngày"; ?></td>
                            <?php } ?>
