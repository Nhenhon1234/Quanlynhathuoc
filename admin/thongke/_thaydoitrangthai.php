...
<div class="modal-content">
    ...
    <form id="formSanPham" method="POST" id="basicform" data-parsley-validate="">       
            ...
            <div class="row">
                <div class="col-12">
                    <label><b>Trạng thái sản phẩm</b><span class="text-danger"> (*)</span></label>
                    <select class="form-control" name="TrangThai" id="TrangThai">
                        <option value="1">Cho phép sử dụng</option>
                        <option value="-1">Ngưng sử dụng</option>
                        <option value="0">Chờ duyệt</option>
                    </select>
                    <input type="text" class="form-control" id="SanPham" name="SanPham" value="ThayDoiTrangThai" hidden />
